...
var Service = (function (_super) {
    ...
    Service.prototype.saveConfiguration = function (data, callback) {
        var _this = this;
        if (!this.referenced)
            return this.reference(function (e) {
                _this.saveConfiguration(data, callback);
            });
    ...
    Service.prototype.dropToService = function (service, method, data, callback) {
        var _this = this;
    ...
    Service.prototype.call = function (service, method, inputData, callback) {
        ...
        this.invokeServiceAction({
            ...
            if (!info.mainOutput)
                return callback(null, info.outputs, function () { });
